...
<head>
    ...
    <title>CC Monitoring System</title>
...
<body>
    ...
    <div class="container-fluid custom-page">
        <div class="row bg-white">
            <!-- The image half -->
            <div class="col-md-6 col-lg-6 col-xl-7" style="
            background: url('{{ asset('images/ccbg.jpg') }}') no-repeat center
              center/cover;
          ">
                <div class="row w-100 mx-auto text-center">
                    <div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto w-100"></div>
                </div>
            </div>
            <!-- The content half -->
                            ...
                            <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                                <div class="card-sigin">
                                    <!-- <div class="mb-5 d-flex">
                                        <a href="index.html" class="header-logo"><img src="bms_logo.png"
                                    ...
                                    <div class="card-sigin">
                                        ...
                                        <div class="main-signup-header">
                                            ...
                                            <h3>
                                                <strong class="text-primary">CC Monitoring System</strong>
                                            </h3>
